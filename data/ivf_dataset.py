...
class MFNet_Dataset(Dataset):
    def __init__(self, dataroot, resolution=256, split='train', data_len=20):
        self.resolution = resolution
        self.data_len = data_len
        self.split = split

        self.vis_path = Util.get_paths_from_images('{}/Visible'.format(dataroot))
        self.ir_path = Util.get_paths_from_images('{}/Infrared'.format(dataroot))
